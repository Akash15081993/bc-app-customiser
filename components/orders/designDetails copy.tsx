            ...
            {partData.image?.url && (
              <Flex alignItems="center" marginTop="xxSmall">
                <img
                  ...
                  alt={`${partName} design`}
                  style={{ width: 80, height: 80, border: "1px solid #ddd", borderRadius: 6, objectFit:'contain' }}
                />
          ...
          {screenshots?.map((s: any, idx: number) => (
            <Box key={idx} marginRight="small" marginBottom="small">
              ...
              <img
                src={s.url}
                alt={s.angle}
                style={{ width: 120, height: 120, border: "1px solid #ddd", borderRadius: 6, objectFit:'contain' }}
              />
            </Box>
          ))}
        </Flex>
